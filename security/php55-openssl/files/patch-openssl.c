--- openssl.c.orig	2015-07-08 14:55:35 UTC
+++ openssl.c
@@ -17,6 +17,7 @@
...
+#include <openssl/ocsp.h>
 ...
 /* Common */
 #include <time.h>
@@ -121,6 +123,39 @@ PHP_FUNCTION(openssl_dh_compute_key);
...
@@ -430,6 +465,12 @@ const zend_function_entry openssl_functi
...
@@ -496,6 +537,7 @@ ZEND_GET_MODULE(openssl)
 static int le_key;
 static int le_x509;
 static int le_csr;
+static int le_crl;
...
@@ -504,6 +546,16 @@ int php_openssl_get_x509_list_id(void) /
 }
 /* }}} */
...
+
 ...
 {
@@ -525,6 +577,21 @@ static void php_csr_free(zend_rsrc_list_
...
@@ -1067,6 +1134,7 @@ PHP_MINIT_FUNCTION(openssl)
...
@@ -1154,6 +1222,36 @@ PHP_MINIT_FUNCTION(openssl)
...
@@ -4526,6 +4624,424 @@ PHP_FUNCTION(openssl_open)
 }
 /* }}} */
