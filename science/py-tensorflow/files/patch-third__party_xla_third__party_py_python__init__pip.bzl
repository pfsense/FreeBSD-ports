--- third_party/xla/third_party/py/python_init_pip.bzl.orig
+++ third_party/xla/third_party/py/python_init_pip.bzl
@@ -1,46 +1,9 @@
...
-    )
+    # FreeBSD: use a local stub repository instead of pip_parse
+    # (no platform wheels available for FreeBSD in requirements_lock)
