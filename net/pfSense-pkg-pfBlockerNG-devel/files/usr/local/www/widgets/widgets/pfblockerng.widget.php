...
function pfBlockerNG_get_header($mode='') {
	...
	if ($pfb['enable'] == 'on' && $pfb['dnsbl'] == 'on' && pfb_validate_vips($pfb['dnsbl_iface'], $pfb['dnsblconfig']['pfb_dnsvip4'], $pfb['dnsblconfig']['pfb_dnsvip6'])[0] && $pfb['unbound_state'] == 'on' && $unbound_validate) {
