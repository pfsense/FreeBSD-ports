...
if (isset($_GET['getsignalstrength'])):
...
<table id="modem" class="table">
    ...
    <a id="ifname"></a></td>
    <td id="status"></td>
    <td id="carrier"><span id="carrier-span"></span>
        <strong id="modem-mode" class="icn"></strong></td>
    <td id="ipaddr"></td>
    </tr>
    </tbody>
</table>
...
<script type="text/javascript">
    ...
    function set_td_widths() {
        try {
            var widths = $.map($($("#widget-interfaces_panel-body .table tbody tr")[0]).children("td"), function(e){return $(e).outerWidth();});

            $("td#macaddr").outerWidth(widths[0]);
            $("td#status").outerWidth(widths[1]);
            $("td#carrier").outerWidth(widths[2]);
            $("td#ipaddr").outerWidth(widths[3]);
        } catch(err) {}
    }

    function init_modem() {
        $('#signal-strength').css('width', '18px').css('height', 'auto')
