...
if (isset($_POST['save']) || !$is_new_entry) {
	...
	if (isset($_POST['save']) && empty($input_errors)) {
		...
		write_config("UDP Broadcast Relay pkg: saved instance.");
		udpbr_resync();
...
$form_spoof_options = array(
	0 => 'Keep Original (default)',
	1 => 'Use Interface Address and Destination Port',
	2 => 'Use Interface Address only'
);
